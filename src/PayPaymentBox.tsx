    ...
    return (
        <div className={"pay-payment-box"}>
            <div className={"pay-payment-box-body"}>
                ...
                <div className={"pay-payment-box-entry"}>
                    Amount: <b>{props.payPayment.amount} GLM</b>
                </div>
                <div className={"pay-payment-box-entry"}>
                    Timestamp: <DateBox date={props.payPayment.timestamp} title={""} />
                </div>
                ...
                <div className={"pay-payment-box-entry"}>
                    Details interpreted as transaction id:
